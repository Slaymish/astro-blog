...
- [ ] Run the five-person, five-second comprehension test described in the July 2026 redesign plan (in git history); revise only if fewer than four people can identify the offer, proof, and next action.
