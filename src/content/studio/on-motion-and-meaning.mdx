...
Used well, motion makes <DefinitionPopover term="structure" subtitle="Relations, not just boxes">How parts relate inside the whole, not just where they sit.</DefinitionPopover> visible.
